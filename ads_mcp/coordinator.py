...
mcp_server = FastMCP(
    ...
    instructions=(
        ...
        " covered by dedicated tools. Use export_gaql_csv instead of"
        " execute_gaql when a bulk extract would be too large for normal"
        " JSON tool output. Keep call_tool for discovery compatibility,"
        " but prefer direct tool calls once tool names are"
